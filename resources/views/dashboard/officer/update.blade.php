...
@section('container')
    <div class="container mx-auto max-w-4xl px-4">
        <form action="/ubah-petugas/{{ $officer->id }}" method="POST"
            class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md">
            <h2 class="text-xl font-semibold text-gray-700 mb-4">Update Officer</h2>
            @csrf
            @method('PUT')
            ...
            <div class="mb-4 relative">
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $officer->name) }}"
            ...
            <div class="mb-4 relative">
                ...
                <input type="email" id="email" name="email" value="{{ old('email', $officer->email) }}"
            ...
            <div class="mb-4 relative">
                ...
                <input type="tel" id="phone" name="phone" value="{{ old('phone', $officer->phone) }}"
            ...
            <!-- Password (Optional) -->
            <div class="mb-4 relative">
                <label for="password" class="block text-sm font-medium text-gray-700">New Password (Leave blank if not
                    changing)</label>
