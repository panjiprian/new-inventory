    ...
    <div class="w-full flex-wrap gap-4">
        <div class="bg-white mt-5 p-5 rounded-lg">
            <div class="flex justify-between">
                <div class="text-left">
                    <h2 class="text-gray-600 font-bold">Officer Data</h2>
                    <a href="/input-petugas" class="text-sm bg-gray-700 text-white block mt-2 px-2 py-1">Input New Officer</a>
                </div>
                <form method="get" action="/petugas" class="form">
                    <div class="flex">
                        <div class="border p-1 px-2 rounded-l">
                          <input id="search" name="search" class="focus:outline-none text-sm" type="text" placeholder="Search Officer">
                        </div>
