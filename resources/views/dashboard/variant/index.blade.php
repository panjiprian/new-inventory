            ...
            <div class="flex justify-between">
                <div class="text-left">
                    ...
                    @if (Auth::user()->role === 'admin')
                        <a href="/input-varian" class="text-sm bg-gray-700 text-white inline-block mt-2 px-2 py-1">Input
                            Variant</a>
                    @endif
                    <a class="text-sm bg-gray-700 text-white inline-block mt-2 px-2 py-1" href="/excel/variants">Export
                        Excel</a>
                </div>
            </div>
                                ...
                                @if (Auth::user()->role === 'admin')
                                    <td class="p-2 flex gap-2">
                                        <button data-id="{{ $variant->id }}"
                                            class="btn-delete-variant bg-red-500 py-1 px-4 rounded text-white">
        ...
        <script>
            $(document).ready(function() {
                $('#variantTabel').DataTable({
                    ...
                    "info": false,
                    "language": {
                        "emptyTable": "No variant available"
                    }
                });
            });
        </script>
