...
<body class="min-h-screen flex items-center justify-center bg-cover" style="background-image: url('{{ asset('image/background.png') }}');">
    <div class="bg-white p-8 rounded-2xl shadow-lg w-96">
      ...
      <div class="mt-6">
        ...
        <form action="{{ route('login') }}" method="post">
          ...
          <button type="submit"
            class="bg-blue-600 text-white w-full py-3 mt-5 rounded-lg font-semibold">
            Log in
          </button>
        </form>
